...
# --exclude as above: this script carries the literal name in its own detection pattern
grep -rqi 'code-guardian' --include='*.md' --include='*.sh' --exclude='validate-definition.sh' . 2>/dev/null \
